    ...
    <body>
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a href="uploadFileServlet?action=new" style="margin-top: -31px;"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <c:forEach items="${listProd}" var="prod">
                            <tr>
                                ...
                                <td>${prod.quantity}</td>
                                <td>
                                    <a href="uploadFileServlet?action=edit&id=${prod.pid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a onclick="return confirm('Are you sure you want to delete this item?')" href="uploadFileServlet?action=delete&id=<c:out value='${prod.pid}' />" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
        ...
        <script>
                                        function searchByName(param) {
                                            ...
                                            $.ajax({
                                                url: "/demo_jsp_serverlet_bootstrap/uploadFileServlet?action=searchForMaPro",
