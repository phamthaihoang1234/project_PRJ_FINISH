        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <div class="container text-left">
                    ...
                    <a href="uploadFileServlet?action=new" class="btn btn-success">Add
                        New Product</a>
                </div>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="prod" items="${listProd}">
                            ...
                            <tr>
                                ...
                                <td><c:if test="${prod.image != null}">
                                        <img src="images/${prod.image}" width="80" height="70" />
                                ...
                                <td><a href="uploadFileServlet?action=edit&id=<c:out value='${prod.pid}' />">Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp; <a onclick="return confirm('Are you sure you want to delete this item?')"
                                                                href="uploadFileServlet?action=delete&id=<c:out value='${prod.pid}' />">Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="uploadFileServlet?action=view&id=<c:out value='${prod.pid}' />">View</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a  href="uploadFileServlet?action=cart&id=<c:out value='${prod.pid}' />">Add to cart</a>
                                </td>
                            </tr>
                        </c:forEach>
                        <!-- } -->
